        ...
        <div class="row">
          <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 text-center">
            <div class="card card-signup">
              <form class="form" action="<?= base_url() ?>login/aksi_login_admin" method="POST">
                ...
                <div class="content">
                  <div class="form-group">
                    <input name="username" type="text" class="form-control underline-input" placeholder="Enter Admin Username">
                  </div>
                  <div class="form-group">
